        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Direccion = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Telefono = table.Column<string>(type: "varchar(28)", maxLength: 28, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medicamento_Proveedor_ProovedorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicamentoComprado_Medicamento_MedicamentoId",
                        column: x => x.MedicamentoId,
                        principalTable: "Medicamento",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicamentoComprado_compra_CompraId",
                        column: x => x.CompraId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicamentoVendido_Medicamento_MedicamentoId",
                        column: x => x.MedicamentoId,
                        principalTable: "Medicamento",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicamentoVendido_Venta_VentaId",
                        column: x => x.VentaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Medicamento_ProovedorId",
                table: "Medicamento",
                column: "ProovedorId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicamentoComprado_CompraId",
                table: "MedicamentoComprado",
                column: "CompraId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicamentoComprado_MedicamentoId",
                table: "MedicamentoComprado",
                column: "MedicamentoId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicamentoVendido_MedicamentoId",
                table: "MedicamentoVendido",
                column: "MedicamentoId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicamentoVendido_VentaId",
                table: "MedicamentoVendido",
                column: "VentaId");
